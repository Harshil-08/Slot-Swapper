...
export const SocketProvider = ({ children }) => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.get('http://localhost:3000/api/swap/notifications');
  ...
  const markAsRead = async (notificationId) => {
    try {
      await axios.patch(`http://localhost:3000/api/swap/notifications/${notificationId}/read`);
  ...
  const markAllAsRead = async () => {
    try {
      await axios.patch('http://localhost:3000/api/swap/notifications/read-all');
